        ...
        <Col md={8} className='m-auto'>
          <Card className='bg-white py-2 px-4'>
            ...
            <Form>
              ...
              <Button type='button' className='btn-light btn-block mb-2'> Upload Image </Button>
            </Form>
          <div className="mb-2">
            <Link to='/account/edit-course'>
              <Button color='primary' className='btn-block'> Edit Bootcamp Details </Button>
            </Link>
          </div>

          <div className="mb-2">
            <Link to='/account/manage-courses'>
              <Button color='secondary' className='btn-block'> Manage Courses </Button>
            </Link>
          </div>

          <div className="mb-2">
            <Button className='btn btn-danger btn-block'> Remove Bootcamp </Button>
          </div>

            <p className="text-muted mt-4"> 	* You can only add one bootcamp per account. </p>
            <p class="text-muted">
