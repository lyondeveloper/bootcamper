...
const ManageBootcamps = lazy(() =>
  import("../../screens/manage-bootcamp/manage-bootcamp.component")
);
const ManageReviews = lazy(() =>
  import("../../screens/manage-reviews/manage-reviews.component")
);
const ManageAccount = lazy(() =>
  import("../../screens/manage-account/manage-account.component")
);
const ManageCourses = lazy(() =>
  import("../../screens/manage-courses/manage-courses.component")
);
